      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <nav className="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <Link href="/blogs" className="hover:text-red-400 transition-colors duration-200">
              Blogs
            </Link>
            <Link href="/portfolio" className="hover:text-red-400 transition-colors duration-200">
              Portfolio
            </Link>
            <Link href="/resume" className="hover:text-red-400 transition-colors duration-200">
              Resume
            </Link>
